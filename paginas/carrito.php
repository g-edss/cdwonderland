                ...
                <div class="collapse navbar-collapse" id="navbarToggler">
                    <ul class="navbar-nav justify-content-between w-100 px-5">
                        <li class="nav-item text-danger">
                            <a href="../paginas/artistas.paginas" class="nav-link">ARTISTAS</a>
                        </li>
                        <li class="nav-item">
                            <a href="../paginas/generos.paginas" class="nav-link">GÉNEROS</a>
                        </li>
                        <li class="nav-item">
                            <a href="../paginas/ediciones-especiales.paginas" class="nav-link">EDICIONES ESPECIALES</a>
                        </li>
                        <li class="nav-item">
                            <a href="../paginas/cuenta.paginas" class="nav-link">CUENTA</a>
                        </li>
                        <li class="nav-item">
                            <a href="../paginas/nosotros.paginas" class="nav-link">NOSOTROS</a>
                        </li>
                    </ul>
                </div>
            </div>
